...
void MainWindow::on_FlipPosition_clicked() {
	if (!ui.FlipPositionLine->text().isEmpty())
	{
		...
		QMessageBox::warning(this, "Warning", "Enter position");
	}
}
...
void MainWindow::on_SetPosition_clicked() {
	if (!ui.SetPositionLine->text().isEmpty())
	{
...
void MainWindow::on_ResetPosition_clicked() {
	if (!ui.ResetPositionLine->text().isEmpty())
	{
