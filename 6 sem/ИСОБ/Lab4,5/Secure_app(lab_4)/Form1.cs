...
namespace Secure_app_lab_4_
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            usersData[1].Role = Roles.Vip;

            usersData[2].Role = Roles.Client;
        }

        private int GetIndex(Button sender) => Convert.ToInt32((sender).Name.Last().ToString()) - 1;

        private bool GetIsServerLagging(int limit = 2) => usersData.FindAll(user => user.IsSignedIn).Count() >= limit;
