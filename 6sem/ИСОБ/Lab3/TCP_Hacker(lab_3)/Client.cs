    ...
    internal class Client
    {
        ...
        public Task ConnectToServer(IPEndPoint serverIP, CancellationTokenSource cancelTokenSource)
        {
            ...
            try
            {
                ...
                SendPacket(clientSocket, TCPPacket.GetEmptyPacket(4, Constants.ClientPort, serverIP.Port, 0, 0, syn: true)); 
                ...
                SendPacket(clientSocket, TCPPacket.GetEmptyPacket(4, Constants.ClientPort, serverIP.Port, 1, 1, ack: true));
                ...
                do
                {
                    ...
                    Thread.Sleep(200);
                    SendPacket(clientSocket, TCPPacket.GetEmptyPacket(4, Constants.ClientPort, serverIP.Port, 1, packet.SequenceNumber + (uint)packet.Data.Length, ack: true));
                    packet = ReadPacket(clientSocket);
                }
                while (!packet.FIN);
