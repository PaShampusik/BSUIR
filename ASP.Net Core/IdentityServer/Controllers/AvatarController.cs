...
public class AvatarController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAvatar()
    {
        ...
        if (user != null)
        {
            string imagePath = Path.Combine(_webHostEnvironment.ContentRootPath, "images", $"{user.Id}.jpg");
        ...
        string defaultFilePath = Path.Combine(_webHostEnvironment.ContentRootPath, "images", "noprofileimage.jpg");
