...
public class TelescopeService : ITelescopeService
{
    ...
    public async Task<ResponseData<ListModel<Telescope>>> GetTelescopeListAsync(string? categoryNormalizedName, int pageNo = 1, int pageSize = 3)
    {
    ...
    public async Task<ResponseData<Telescope>> GetTelescopeByIdAsync(int id)
    {
    ...
    public async Task UpdateTelescopeAsync(int id, Telescope product)
    {
        var clothes = await _dbContext.Telescopes.FindAsync(id);
        if (clothes is null)
        {
    ...
    public async Task DeleteTelescopeAsync(int id)
    {
        var clothes = await _dbContext.Telescopes.FindAsync(id);
        if (clothes is null)
        {
    ...
    public async Task<ResponseData<Telescope>> CreateTelescopeAsync(Telescope product)
    {
